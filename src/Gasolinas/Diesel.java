...
public class Diesel extends javax.swing.JFrame {
    ...
    public Diesel() {
        ...
        jTextField6.setText(jTextField6.getText()+ Diesel.getvalor());
    }
    
   double num1;
    Dolar dolas = new Dolar("dolares EEUU",19.6);
    Euros euros = new Euros("euros",20.00);
    Dhiesel Diesel = new Dhiesel(21.30);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gasolina : Diesel $");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        multiplicacion = Double.parseDouble(jTextField1.getText()) * Diesel.getvalor();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Diesel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
